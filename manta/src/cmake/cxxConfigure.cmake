...
#
if (${GNU_COMPAT_COMPILER})
    # boost 1.75+ math headers require C++14; use c++14 for modern clang
    # (Apple clang reports a low root-LLVM version, so key off APPLE instead)
    if (APPLE OR (CMAKE_CXX_COMPILER_ID STREQUAL "Clang" AND COMPILER_VERSION VERSION_GREATER_EQUAL "8.0"))
        append_args (CMAKE_CXX_FLAGS "-std=c++14")
    elseif ((NOT ${CMAKE_CXX_COMPILER_ID} STREQUAL "Intel") OR (${COMPILER_VERSION} VERSION_LESS "15.0"))
